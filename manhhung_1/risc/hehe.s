...
hours_ten_s: .byte 0
hours_one_s: .byte 0         # Lưu trữ số giờ
minutes_ten_s: .byte 0
minutes_one_s: .byte 0
seconds_ten_s: .byte 0     # Lưu trữ số phút
seconds_one_s: .byte 0     # Lưu trữ số giây
rows:
...
loop:
    ...
    li a5,3
    sb a5,0(a6)
    lb a3, hours_ten_s   # Chọn số để hiển thị (ví dụ: 4)
    li s0, HOUR_TEN
    jal display_number
    li a3, 2  
    li s0, HOUR_ONE
