...
main:
    li x5, 10       # Tải giá trị 10 vào thanh ghi x5
    li x6, 20       # Tải giá trị 20 vào thanh ghi x6
    add x7, x5, x6  # Cộng x5 và x6, kết quả lưu vào x7

    # Trả về 0 từ hàm main
    li a0, 0        # Đưa giá trị trả về vào a0 (theo chuẩn ABI)
    ret             # Trả về
